...
int main(int argc, char **argv)
{
	...
	Vertex2DColor vertices[] = {
		Vertex2DColor(glm::vec2(-0.5f, -0.5f), glm::vec3(1.f, 0.f, 0.f)), // premier sommet
		Vertex2DColor(glm::vec2(0.5f, -0.5f), glm::vec3(0.f, 1.f, 0.f)),  // deuxième sommet
		Vertex2DColor(glm::vec2(-0.5f, 0.5f), glm::vec3(0.f, 0.f, 1.f)),  // troisième sommet

		Vertex2DColor(glm::vec2(-0.5f, 0.5f), glm::vec3(0.f, 0.f, 1.f)), // premier sommet
		Vertex2DColor(glm::vec2(0.5f, -0.5f), glm::vec3(0.f, 1.f, 0.f)), // deuxième sommet
		Vertex2DColor(glm::vec2(0.5f, 0.5f), glm::vec3(0.f, 0.f, 1.f))	 // troisième sommet
	};
	GLuint vbo, vao;
